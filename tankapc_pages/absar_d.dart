...
class AbsarD extends StatefulWidget {
  const AbsarD({super.key});

  @override
  AbsarDState createState() => AbsarDState();
}

class AbsarDState extends State<AbsarD> with TickerProviderStateMixin {
  bool isHovered = false;
  Color textColor = Colors.black;
  String _selectedImage = 'assets/ABSAR_DIND.JPG';
  bool showMore = false;
            ...
            VisibilityDetector(
              ...
              child: FadeTransition(
                ...
                child: ScaleTransition(
                  ...
                  child: const Text(
                    ' ABSAR-D is a short-range Thermal Sight to facilitate night vision for driver of the Armoured Personal Carrier (APC). It uses uncooled thermal imaging technology with fixed zoom lens. It complies with US MIL-STD-810G',
                    textAlign: TextAlign.center,
                    style: TextStyle(
                      fontSize: 17,
                      fontFamily: 'Playfair',
      ...
      child: Row(
        ...
        children: [
          Column(
            ...
            children: [
              _buildThumbnail('assets/ABSAR_DIND.JPG'),
            ],
          ),
        ...
        if (showSpecifications)
          Table(
            ...
            children: [
                      ...
                      _buildTableRow('Objective Lens', '19 mm, Fixed Focus'),
                      _buildTableRow('Focus Range', '5m – Infinity'),
                      _buildTableRow('Field of View', '32° x 24°'),
                      _buildTableRow('Display', '8" LCD, 1024×600, Auto Brightness'),
                      _buildTableRow('NETD', '<70 mK'),
                      _buildTableRow('Electronic Zoom', '1X, 2X, 3X, 4X'),
                      _buildTableRow('Polarity', 'WH/BH/Sepia/Fire/Iron/Rainbow'),
                      _buildTableRow('Battery Type', '24V Li-Ion Batter Pack (Rechargeable)'),
                      ...
                      _buildTableRow('Weight', '≤ 8 kg (without battery)'),
