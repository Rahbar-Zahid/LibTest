...
class AbsarC extends StatefulWidget {
  const AbsarC({super.key});

  @override
  AbsarCState createState() => AbsarCState();
}

class AbsarCState extends State<AbsarC> with TickerProviderStateMixin {
  bool isHovered = false;
  Color textColor = Colors.black;
  String _selectedImage = 'assets/ABSAR_CIND.JPG';
  bool showMore = false;
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'THERMAL SIGHT FOR APC COMMANDER (ABSAR-C)',
            ...
            VisibilityDetector(
              ...
              child: FadeTransition(
                ...
                child: ScaleTransition(
                  ...
                  child: const Text(
                    'ABSAR-C is a long-range Thermal Sight to facilitate night vision for Commander of Armoured Personal Carrier (APC). It is based on uncooled thermal imaging technology with motorized zoom and auto focussing features. It complies with US MIL-STD-810G.',
                    textAlign: TextAlign.center,
                    style: TextStyle(
                      fontSize: 17,
                      fontFamily: 'Playfair',
      ...
      child: Row(
        ...
        children: [
          Column(
            ...
            children: [
              _buildThumbnail('assets/ABSAR_CIND.JPG'),
            ],
          ),
      ...
      children: [
        ...
        if (showSpecifications)
          Table(
            ...
            children: [
                      _buildTableRow('Sensor Type', 'Un-cooled'),
                      _buildTableRow('Sensor Size', '640×480, 17um (or better)'),
                      _buildTableRow('Spectral Response', '8 - 14 µm'),
                      _buildTableRow('Sensors', 'DMC (±10mil) & Hour Meter'),
                      _buildTableRow('Objective Lens', '30~150mm, Motorized Zoom Auto Focus'),
                      _buildTableRow('Focusing Range', '5m – Infinity'),
                      _buildTableRow('Field of View', '20.6° x 15.5° | 4.2° x 3.1°'),
                      _buildTableRow('Optical Zoom', '5X'),
                      _buildTableRow('Display', '10" LCD 1024×768, Auto Brightness'),
                      _buildTableRow('Electronic Zoom', '1X, 2X, 3X, 4X'),
                      _buildTableRow('Polarity', 'WH/BH/Sepia/Fire/Iron/Rainbow'),
                      _buildTableRow('Battery Type', '24V Li-Ion Battery Pack(Rechargeable)'),
                      _buildTableRow('Battery Capacity', '24V +- 3v/ 6.5AH'),
                      _buildTableRow('Endurance Time', '> 8 hrs'),
                      _buildTableRow('Weight', '< 12 kg (without battery)'),
                      _buildTableRow('Encapsulation', 'TI Module IP67, LCD IP66'),
                      _buildTableRow('Qualification', 'MIL-STD-810G'),
                      _buildTableRow('Video/PICs Storage', 'Embedded 64GB'),
                      _buildTableRow('Video Output', 'PAL'),
                      _buildTableRow('NETD', '≤70mK'),
                      _buildTableRow('Mechanical Interface', 'LCD Panel (APC M-17 slot)'),
                      _buildTableRow('Operating Temperature', '-5°C to + 55°C'),
            ],
          ),
      ],
    );
