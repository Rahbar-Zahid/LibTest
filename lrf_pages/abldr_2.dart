...
class Abldr2 extends StatefulWidget {
  const Abldr2({super.key});

  @override
  Abldr2State createState() => Abldr2State();
}

class Abldr2State extends State<Abldr2> with TickerProviderStateMixin {
  bool isHovered = false;
  Color textColor = Colors.black;
  String _selectedImage = 'assets/ABLDR_2IND.JPG';
  bool showMore = false;
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'AIRBORNE LASER DESIGNATOR & RANGER (ABLDR-2A)',
            ...
            VisibilityDetector(
              ...
              child: FadeTransition(
                ...
                child: ScaleTransition(
                  ...
                  child: const Text(
                    'Airborne Laser Designator and Ranger is a high-performance laser-based system. ABLDR-2A designates a target for a laser-guided weapon homing. It is capable to designate using NATO/ WARSAW or user-defined codes, with excellent beam quality and stable bore sight over the full temperature range. It complies with US MIL-STD-810G & MIL-STD-461E.',
                    textAlign: TextAlign.center,
                    style: TextStyle(
                      fontSize: 17,
                      fontFamily: 'Playfair',
      ...
      child: Row(
        ...
        children: [
          Column(
            ...
            children: [
              _buildThumbnail('assets/ABLDR_2IND.JPG'),
  ...
  Widget _buildApplicability() {
    return Column(
      children: [
        ...
        if (showDetails)
          Text(
            '• Diodes are used as pumping source instead of flashlamps \n• Low divergence and high-quality laser beam \n• stable bore sight over the full temperature range',
            textAlign: TextAlign.left,
      ...
      children: [
        ...
        if (showSpecifications)
          Table(
            ...
            children: [
                      _buildTableRow('Laser Type', 'Nd: YAG'),
                      _buildTableRow('Wavelength', '1064nm'),
                      _buildTableRow('Pulse Energy', '≥ 80mJ'),
                      _buildTableRow('Pumping Source', 'Laser Diode'),
                      _buildTableRow('Range', '(200m to 20km)'),
                      _buildTableRow('Accuracy', '+- 5m'),
                      _buildTableRow('Pulse Width', '< 25 nSec'),
                      _buildTableRow('Divergence', '0.35 mRad'),
                      _buildTableRow('Designation Frequency', '8 – 21 Hz'),
                      _buildTableRow('Lasing Cycle', '90 sec'),
                      _buildTableRow('Communication', 'RS-422'),
                      _buildTableRow('Operating Temperature', '-20°C to +55°C'),
                      _buildTableRow('Qualification', 'MIL-STD-810G & MIL-STD-461E'),
                      _buildTableRow('Weight', '< 7.2kg'),
            ],
          ),
      ],
    );
