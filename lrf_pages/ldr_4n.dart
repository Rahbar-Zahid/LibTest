...
class Ldr4n extends StatefulWidget {
  const Ldr4n({super.key});

  @override
  Ldr4nState createState() => Ldr4nState();
}

class Ldr4nState extends State<Ldr4n> with TickerProviderStateMixin {
  bool isHovered = false;
  Color textColor = Colors.black;
  String _selectedImage = 'assets/AR_3IND.JPG';
  bool showMore = false;
            ...
            VisibilityDetector(
              ...
              child: FadeTransition(
                ...
                child: ScaleTransition(
                  ...
                  child: const Text(
                    'A high performance, compact and light-weight system. LDR-4 is capable of designating up to 5 km using NATO/ WARSAW or user-defined codes, with excellent beam quality and stable bore sight over the full temperature range. It complies with US MIL-STD-810G.',
                    textAlign: TextAlign.center,
                    style: TextStyle(
                      fontSize: 17,
                      fontFamily: 'Playfair',
      ...
      child: Row(
        ...
        children: [
          Column(
            ...
            children: [
              _buildThumbnail('assets/AR_3IND.JPG'),
      ...
      children: [
        ...
        if (showSpecifications)
          Table(
            ...
            children: [
                      _buildTableRow('Field of View of Telescope', '4.5°'),
                      _buildTableRow('Magnification of Telescope', 'x13'),
                      _buildTableRow('Cooling Pump', 'Liquid Flow'),
                      _buildTableRow('LRF Range', '10 Km'),
                      _buildTableRow('Designation Range', '5 Km'),
                      _buildTableRow('Energy', '> 80mJ'),                 
                      _buildTableRow('Divergence', '≤0.35mrad'),
                      _buildTableRow('Azimuth', '360 Degree (1-6400 mils)'),
                      _buildTableRow('Elevation (Up)', '28.5 Degree (0-499 mils)'),
                      _buildTableRow('Elevation (Down)', '28.5 Degree (0-499 mils)'),
                      _buildTableRow('Battery Type', 'Ni-Cd Battery Pack (Rech)'),
                      _buildTableRow('Field of View of Telescope', '4.5°'),
                      _buildTableRow('Operating Temperature', '-10°C to +55°C'),
                      _buildTableRow('Weight', '< 11.7 Kg'),
                      _buildTableRow('Dimensions (L x W x H)', '36 x 34 x 17 cm'),
