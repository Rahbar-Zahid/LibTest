...
class Aa3 extends StatefulWidget {
  const Aa3({super.key});

  @override
  Aa3State createState() => Aa3State();
}

class Aa3State extends State<Aa3> with TickerProviderStateMixin {
            ...
            VisibilityDetector(
              ...
              child: FadeTransition(
                ...
                child: ScaleTransition(
                  ...
                  child: const Text(
                    'A compact, high performance laser range finder that is suitable for stand-alone airborne range finding applications. It offers true plug and play compatibility within a host of aerial platforms.',
                    textAlign: TextAlign.center,
                    style: TextStyle(
                      fontSize: 17,
                      fontFamily: 'Playfair',
  ...
  Widget _buildApplicability() {
    return Column(
      children: [
        ...
        if (showDetails)
          Text(
            '• 0.5Hz repetition rate \n• Environmental performance to MIL-STD-810F',
            textAlign: TextAlign.left,
        ...
        if (showSpecifications)
          Table(
            ...
            children: [
                      ...
                      _buildTableRow('Aperture', '30 mm'),
                      _buildTableRow('Operating Voltage', '18-32v (28v Nominal)'),
                      _buildTableRow('Range of Display', '4 Digits LED'),
                      _buildTableRow('Range Accuracy', '+10ft'),
                      _buildTableRow('Max/Min range', '9995 ft/100 ft'),
                      _buildTableRow('Range update rate', '1 Hz (max)'),
                      _buildTableRow('Readings/Charge', 'Over 600 at 20°C'),
                      _buildTableRow('Operating Temperature', '-30°C to +55°C'),
                      _buildTableRow('Dimensions', '25 x 20 x 11 cm'),
                      _buildTableRow('Weight', '1.9 kg'),
            ],
          ),
      ],
    );
