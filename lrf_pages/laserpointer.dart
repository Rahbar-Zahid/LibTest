...
class Laserpointer extends StatefulWidget {
  const Laserpointer({super.key});

  @override
  LaserpointerState createState() => LaserpointerState();
}

class LaserpointerState extends State<Laserpointer> with TickerProviderStateMixin {
      ...
      children: [
        ...
        if (showSpecifications)
          Table(
            ...
            children: [
                     _buildTableRow('Laser Source', 'Diode'),
                      _buildTableRow('Wavelength', '830nm to 850nm'),
                      _buildTableRow('Spatial Mode', 'Single Mode'),
                      _buildTableRow('Beam Shape', 'Elliptical'),
                      _buildTableRow('Beam Divergence', '≤ 0.5mrad'),
                      _buildTableRow('Operating Modes', 'CW or 10 Hz (50% DS)'),
                      _buildTableRow('Power Output (Optical)', '≥ 80mW or ≥ 180mW'),
                      _buildTableRow('Power Supply', '28v DC'),
                      _buildTableRow('Electrical Consumption', '1.7W'),
                      _buildTableRow('Laser Class', '3B'),
            ],
          ),
      ],
    );
