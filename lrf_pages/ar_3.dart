...
class Ar3 extends StatefulWidget {
  const Ar3({super.key});

  @override
  Ar3State createState() => Ar3State();
}

class Ar3State extends State<Ar3> with TickerProviderStateMixin {
            ...
            VisibilityDetector(
              ...
              child: FadeTransition(
                ...
                child: ScaleTransition(
                  ...
                  child: const Text(
                    ' A compact, high performance laser range finder that is suitable for stand-alone military-based range finding applications. It offers true plug and play compatibility with military equipment. It complies with US MIL-STD-810G.',
                    textAlign: TextAlign.center,
                    style: TextStyle(
                      fontSize: 17,
                      fontFamily: 'Playfair',
  ...
  Widget _buildApplicability() {
    return Column(
      children: [
        ...
        if (showDetails)
          Text(
            '• 0.2Hz repetition rate \n• Multi target ranging \n• Low weight and handy \n• Usable in wide temperature',
            textAlign: TextAlign.left,
      ...
      children: [
        ...
        if (showSpecifications)
          Table(
            ...
            children: [
                      _buildTableRow('Laser Type', 'Nd: YAG (1.064 µm)'),
                      _buildTableRow('Pulse Energy', '10 mJ (nominal)'),
                      _buildTableRow('Pulse Width', '10 nSec'),
                      _buildTableRow('Beam Divergence', '< 1.0 mRad'),
                      _buildTableRow('Pulses/min', '15 (30 for short time)'),
                      _buildTableRow('Field of View (Telescope)', '6.75°'),
                      _buildTableRow('Range of Display', '4 Digits LED'),
                      _buildTableRow('Range Accuracy', '+5m'),
                      _buildTableRow('Max/Min Range', '9995 / 200 m'),
                      _buildTableRow('Magnification (Telescope)', '7X'),
                      _buildTableRow('Field of view (Receiver)', '2.0 mrad'),
                       _buildTableRow('Battery Capacity', '12v/0.5 Ah'),
                      _buildTableRow('Battery Type', 'Ni-Cd Battery Pack'),
                      _buildTableRow('Operating Temperature', '-30°C to +55°C'),
                      _buildTableRow('Dimensions', '25 x 20 x 11 cm'),
                      _buildTableRow('Weight', '2.2 kg'),
