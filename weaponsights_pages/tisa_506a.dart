...
class Tisa506A extends StatefulWidget {
  const Tisa506A({super.key});

  @override
  Tisa506AState createState() => Tisa506AState();
}

class Tisa506AState extends State<Tisa506A> with TickerProviderStateMixin {
  bool isHovered = false;
  Color textColor = Colors.black;
  String _selectedImage = 'assets/TISA_506BIND.JPG';
  bool showMore = false;
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'THERMAL WEAPON SIGHT (TISA-506A)',
            ...
            VisibilityDetector(
              ...
              child: FadeTransition(
                ...
                child: ScaleTransition(
                  ...
                  child: const Text(
                    'It is a compact light weight thermal weapon sight which can be mounted on short range weapons (SMG, G3, M4). It enables the soldiers to aim in the darkness even in adverse weather conditions.',
                    textAlign: TextAlign.center,
                    style: TextStyle(
                      fontSize: 17,
                      fontFamily: 'Playfair',
      ...
      child: Row(
        ...
        children: [
          Column(
            ...
            children: [
              _buildThumbnail('assets/TISA_506BIND.JPG'),
            ],
          ),
        ...
        if (showSpecifications)
          Table(
            ...
            children: [
                      ...
                      _buildTableRow('Sensor Size', '640×480, 17um'),
                      _buildTableRow('Spectral Response', '8 - 14 µm'),
                      _buildTableRow('NETD', '≤70mK'),
                      _buildTableRow('Objective Lens', '50mm, Manual focus'),
                      _buildTableRow('Focusing Range', '5m – Infinity'),
                      _buildTableRow('Field of View', '12.4° x 9.3° (1X)'),
                      ...
                      _buildTableRow('Battery Type', '4x AA Ni-MH (Rechargeable)'),
                      _buildTableRow('Battery Life', '> 6 hours'),
                      _buildTableRow('Built-in Memory', '32GB'),
                      _buildTableRow('Built-in Capacity', '12hrs video recording or > 30K snapshots'),
                      _buildTableRow('Material Operation', '-35°C to +55°C'),
                      _buildTableRow('Encapsulation', 'IP67'),
                      _buildTableRow('Vibration Shock', 'MIL-STD-810G'),
                      _buildTableRow('Weight', '750g (without battery)'),
            ],
          ),
      ],
    );
