...
class Tisa506B extends StatefulWidget {
  const Tisa506B({super.key});

  @override
  Tisa506BState createState() => Tisa506BState();
}

class Tisa506BState extends State<Tisa506B> with TickerProviderStateMixin {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'THERMAL WEAPON SIGHT (TISA-506B)',
            ...
            VisibilityDetector(
              ...
              child: FadeTransition(
                ...
                child: ScaleTransition(
                  ...
                  child: const Text(
                    'TISA-506B is a medium-range Thermal Weapon Sight to facilitate night firing capability for soldier on short range weapons (SMG, G3A3, M4 and M249). It uses uncooled thermal imaging technology with manual focus lens. It complies with US MIL-STD-810G.',
                    textAlign: TextAlign.center,
                    style: TextStyle(
                      fontSize: 17,
                      fontFamily: 'Playfair',
        ...
        if (showSpecifications)
          Table(
            ...
            children: [
                      ...
                      _buildTableRow('Field of View', '12.4° x 9.3°='),
                      ...
                      _buildTableRow('Battery Type', '1x Li-Ion Cell (Rechargeable)'),
                      _buildTableRow('Endurance Time', '> 4 hours'),
                      _buildTableRow('Operating Temperature', '-35°C to +55°C'),
                      _buildTableRow('Encapsulation', 'IP67'),
                      _buildTableRow('Mechanical Interface', 'MIL-STD-1913'),
                      _buildTableRow('Qualification', 'MIL-STD-810G'),
                      _buildTableRow('Weight', '< 600g'),
            ],
          ),
      ],
    );
