...
class Qanis1 extends StatefulWidget {
  const Qanis1({super.key});

  @override
  Qanis1State createState() => Qanis1State();
}

class Qanis1State extends State<Qanis1> with TickerProviderStateMixin {
            ...
            VisibilityDetector(
              ...
              child: FadeTransition(
                ...
                child: ScaleTransition(
                  ...
                  child: const Text(
                    'QANIS is a thermal scope designed to quickly clip on with existing day scope.  A clip-on thermal scope allows to quickly switch between normal and thermal optcs without removing riflescope. Re-zeroing of riflescope is not needed while attaching or removing the clip-on. Ballistic data of day sight will be utilized with enhanced vision at night. It complies with US MIL-STD-810G.',
                    textAlign: TextAlign.center,
                    style: TextStyle(
                      fontSize: 17,
                      fontFamily: 'Playfair',
        ...
        if (showSpecifications)
          Table(
            ...
            children: [
                      ...
                      _buildTableRow('Sensor Size', '640 x 480, 17 µm(or better)'),
