...
class MobileAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  Widget build(BuildContext context) {
    return AppBar(
      ...
      elevation: 4.0,
      centerTitle: true, // Center title only on mobile
      leading: !kIsWeb
          ? IconButton(
      ...
      bottom: TabBar(
              ...
              child: PopupMenuButton<String>(
                ...
                itemBuilder: (BuildContext context) => <PopupMenuEntry<String>>[
                  const PopupMenuItem<String>(
                    ...
                    child: Text('Surveillance Products', style: TextStyle(fontFamily: 'Roboto')),
                  ),
                  const PopupMenuItem<String>(
                    value: 'Weapon\'s Sights',
                    child: Text('Weapon Sights', style: TextStyle(fontFamily: 'Roboto')),
                  ),
                  const PopupMenuItem<String>(
                    value: 'Tank/APC\'s Sights',
                    child: Text('Tank/APC\'s Sights', style: TextStyle(fontFamily: 'Roboto')),
                  ),
                  const PopupMenuItem<String>(
                    value: 'LRF & LTDR',
                    child: Text('LRF & LTDR', style: TextStyle(fontFamily: 'Roboto')),
                  ),
                ],
                color: Colors.white,
                child: Row(
            ...
            return Tab(
              child: PopupMenuButton<String>(
                ...
                itemBuilder: (BuildContext context) => <PopupMenuEntry<String>>[
                  const PopupMenuItem<String>(
                    value: 'E-learning',
                    child: Text('E-learning', style: TextStyle(fontFamily: 'Roboto')),
                  ),
                  const PopupMenuItem<String>(
                    value: 'Webinars',
                    child: Text('Webinars', style: TextStyle(fontFamily: 'Roboto')),
                  ),
                  // const PopupMenuItem<String>(
                  //   value: 'Help Articles',
        ...
        labelColor: const Color.fromARGB(255, 12, 88, 150),
        unselectedLabelColor: Colors.white,
        isScrollable: true,
        indicatorColor: const Color.fromARGB(255, 12, 88, 150), // Match indicator color to AppBar
      ),
    );
  }

  @override
  Size get preferredSize => const Size.fromHeight(56); // Height for mobile
}
