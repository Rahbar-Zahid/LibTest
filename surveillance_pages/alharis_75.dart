...
class Alharis75 extends StatefulWidget {
  const Alharis75({super.key});

  @override
  Alharis75State createState() => Alharis75State();
}

class Alharis75State extends State<Alharis75> with TickerProviderStateMixin {
  bool isHovered = false;
  Color textColor = Colors.black;
  String _selectedImage = 'assets/ALHARIS_75IND.JPG';
  bool showMore = false;
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'THERMAL IMAGER SURVEILLANCE CAMERA (ALHARIS-75)',
            ...
            VisibilityDetector(
              ...
              child: FadeTransition(
                ...
                child: ScaleTransition(
                  ...
                  child: const Text(
                    'Long-range Thermal Imager based night vision surveillance sight. It can be integrated with any type of high-resolution   pan-tilt with video over Ethernet. It can be equally used in the day & night �me for Area Surveillance and Perimeter Security. It complies with US MIL-STD-810G.',
                    textAlign: TextAlign.center,
                    style: TextStyle(
                      fontSize: 17,
                      fontFamily: 'Playfair',
      ...
      child: Row(
        ...
        children: [
          Column(
            ...
            children: [
              _buildThumbnail('assets/ALHARIS_75IND.JPG'),
              const SizedBox(height: 8),
              _buildThumbnail('assets/ALHARIS_75IND_2.JPG'),
            ],
          ),
        ...
        if (showSpecifications)
          Table(
            ...
            children: [
                      ...
                      _buildTableRow('Sensor Size', '640×480, 17µm (or better)'),
                      _buildTableRow('Spectral Response', '8-14µm'),
                      _buildTableRow('Objective Lens', '75mm, Fixed Focus'),
                      _buildTableRow('Focus Range', '5m – Infinity'),
                      _buildTableRow('Field of View', '8° x 6°'),
                      _buildTableRow('NETD', '<70 mK'),
                      _buildTableRow('Electronic Zoom', '1X, 2X, 3X, 4X'),
                      _buildTableRow('Video Output', 'PAL, Ethernet'),
                      _buildTableRow('Connectivity', 'ONVIF, PELCO-D'),
                      _buildTableRow('PTZ', 'Yes (Optional)'),
                      _buildTableRow('Operating Voltage', '12 V DC'),
