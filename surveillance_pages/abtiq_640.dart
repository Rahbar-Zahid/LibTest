...
import 'package:flutter_application_1/tabs/contact_us.dart';
...
class Abtiq640 extends StatefulWidget {
  const Abtiq640({super.key});

  @override
  Abtiq640State createState() => Abtiq640State();
}

class Abtiq640State extends State<Abtiq640> with TickerProviderStateMixin {
  bool isHovered = false;
  Color textColor = Colors.black;
  String _selectedImage = 'assets/ABTIQ_640IND.JPG';
  bool showMore = false;
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'AIRBORNE TI IMAGING FOR SMALL UAV (ABTIQ-256)',
            ...
            VisibilityDetector(
              ...
              child: FadeTransition(
                ...
                child: ScaleTransition(
                  ...
                  child: const Text(
                    'ABTIQ-256 is a short-range Thermal Sight for UAVs and Quadcopters to facilitate night surveillance operations. It uses uncooled thermal imaging technology. It is a light weight TI solution ideal for UAV applications. It enables the UAVs to detect and engage the targets. It complies with US MIL-STD-810G.',
                    textAlign: TextAlign.center,
                    style: TextStyle(
                      fontSize: 17,
                      fontFamily: 'Playfair',
      ...
      child: Row(
        ...
        children: [
          Column(
            ...
            children: [
              _buildThumbnail('assets/ABTIQ_640IND.JPG'),
              const SizedBox(height: 8),
              _buildThumbnail('assets/ABTIQ_640_2_IND.JPG'),
            ],
          ),
  ...
  Widget _buildApplicability() {
    return Column(
      children: [
        ...
        if (showDetails)
          Text(
            '• A Compact TI sight for small UAVs \n• Quadcopter',
            textAlign: TextAlign.left,
        ...
        if (showSpecifications)
          Table(
            ...
            children: [
              ...
              _buildTableRow('Objective Lens', '25 mm, Fixed Focus'),
              _buildTableRow('Focus Range', '5m – Infinity'),
              _buildTableRow('Field of View', '23° x 18°'),
              _buildTableRow('NETD', ' ≤70 mK'),
              _buildTableRow('Electronic Zoom', '1X, 2X, 3X, 4X'),
              _buildTableRow('Polarity', 'WH/BH/Sepia/Fire/Iron/Rainbow'),
              _buildTableRow('Video Out', 'PAL, Ethernet'),
              _buildTableRow('Connectivity', 'ONVIF , RTSP, PELCO-D'),
              _buildTableRow('Operating Voltage', '12V DC'),
