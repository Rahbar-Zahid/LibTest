...
class Tib7863 extends StatefulWidget {
  const Tib7863({super.key});

  @override
  Tib7863State createState() => Tib7863State();
}

class Tib7863State extends State<Tib7863> with TickerProviderStateMixin {
  bool isHovered = false;
  Color textColor = Colors.black;
  String _selectedImage = 'assets/TI786_3IND.jpg';
  bool showMore = false;
            ...
            VisibilityDetector(
              ...
              child: FadeTransition(
                ...
                child: ScaleTransition(
                  ...
                  child: const Text(
                    'A long range compact thermal imager-based night vision goggle. It is primarily hand held device but can also be mounted on Tripod for long missions.',
                    textAlign: TextAlign.center,
                    style: TextStyle(
                      fontSize: 17,
                      fontFamily: 'Playfair',
      ...
      child: Row(
        ...
        children: [
          Column(
            ...
            children: [
              _buildThumbnail('assets/TI786_3IND.JPG'),
            ],
          ),
  ...
  Widget _buildApplicability() {
    return Column(
      children: [
        ...
        if (showDetails)
          Text(
            '• Long range TI sight for surveillance',
            textAlign: TextAlign.left,
        ...
        if (showSpecifications)
          Table(
            ...
            children: [
                      ...
                      _buildTableRow('Objective Lens', '75mm, Manual focus'),
                      _buildTableRow('Focusing Range', '5m-Infinity'),
                      _buildTableRow('Field of View', '8.2° x 6.2°'),
                      ...
                      _buildTableRow('Battery Type', '4 x AA NiMH (Rechargeable/Non-Recharge)'),
                      ...
                      _buildTableRow('Weight', '1.6 Kg (without battery)'),
            ],
          ),
      ],
    );
