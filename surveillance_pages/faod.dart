...
class Faod extends StatefulWidget {
  const Faod({super.key});

  @override
  FaodState createState() => FaodState();
}

class FaodState extends State<Faod> with TickerProviderStateMixin {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'MULTI SENSOR SURVEILLANCE SYSTEM (FAOD)',
            ...
            VisibilityDetector(
              ...
              child: FadeTransition(
                ...
                child: ScaleTransition(
                  ...
                  child: const Text(
                    'FAOD is a forward artillery observation device. It is a multi-sensor system which calculates the target coordinates on WGS-84 and LCC reference grid. It can be utilized for conducting forward area surveillance through an integrated thermal imager, day sight, and related sensors. Additionally, it complies with US MIL-STD-810G.',
                    textAlign: TextAlign.center,
                    style: TextStyle(
                      fontSize: 17,
                      fontFamily: 'Playfair',
        ...
        if (showSpecifications)
          Table(
            ...
            children: [
                      ...
                      _buildTableRow('Objective Lens', '100mm, Manual Focus'),
                      _buildTableRow('Field of View', '6.2° x 4.7°'),
                      _buildTableRow('Day Sight Sensor', 'CMOS'),
                      _buildTableRow('Optical Zoom', '30X'),
                      _buildTableRow('LASER Type', 'Eye Safe (1540nm)'),
                      _buildTableRow('Maximum Range', '7Km ± 2m'),
                      _buildTableRow('Compass Accuracy', '± 0.5°'),
                      _buildTableRow('GPS Type', 'NAVSTAR/ GLONASS/ BEIDOU'),
                      _buildTableRow('Display Type', 'Color AMOLED Display'),             
                      _buildTableRow('Operating Temperature', '-20°C to +50°C'),
                      _buildTableRow('Encapsulation', 'IP67'),
                      _buildTableRow('Qualification', 'MIL-STD-810G'),
                      _buildTableRow('Weight', '3.6kg (without battery)'),
            ],
          ),
      ],
    );
