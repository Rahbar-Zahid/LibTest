...
class Tib7861 extends StatefulWidget {
  const Tib7861({super.key});

  @override
  Tib7861State createState() => Tib7861State();
}

class Tib7861State extends State<Tib7861> with TickerProviderStateMixin {
  bool isHovered = false;
  Color textColor = Colors.black;
  String _selectedImage = 'assets/TIB786_1IND.JPG';
  bool showMore = false;
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'SHORT RANGE THERMAL BINOCULAR (TIB786-1)',
            ...
            VisibilityDetector(
              ...
              child: FadeTransition(
                ...
                child: ScaleTransition(
                  ...
                  child: const Text(
                    'TIB786-1 is a short-range Thermal Imaging biocular to facilitate night vision capability for soldier. It uses uncooled thermal imaging technology with fixed focus lens. It is primarily hand-held device and can also be mounted on Helmet for long missions. It complies with US MIL-STD-810G.',
                    textAlign: TextAlign.center,
                    style: TextStyle(
                      fontSize: 17,
                      fontFamily: 'Playfair',
      ...
      child: Row(
        ...
        children: [
          Column(
            ...
            children: [
              _buildThumbnail('assets/TIB786_1IND.JPG'),
            ],
          ),
  ...
  Widget _buildApplicability() {
    return Column(
      children: [
        ...
        if (showDetails)
          Text(
            '• Short Range TI sight for surveillance',
            textAlign: TextAlign.left,
        ...
        if (showSpecifications)
          Table(
            ...
            children: [
                      ...
                      _buildTableRow('Sensor Size', '	384×288, 17um'),
                      _buildTableRow('Spectral Response', '8 - 14 µm'),
                      _buildTableRow('NETD', '≤100mK'),
                      _buildTableRow('Objective Lens', '35mm, fixed focus'),
                      _buildTableRow('Focus Range', '5m – Infinity'),
                      _buildTableRow('Field of View', '10.6° x 8.0°'),
                      _buildTableRow('Display', 'Color AMOLED Display (800×600)'),
                      _buildTableRow('Electronic Zoom', '1X, 2X, 4X'),
                      _buildTableRow('Polarity', 'WH/BH/Sepia/Fire/Iron/Rainbow'),
                      _buildTableRow('Battery Type', '2x Li-Ion Cells (Rechargeable)'),
                      _buildTableRow('Endurance Time', '> 6 hours'),
                      _buildTableRow('Mechanical Interface', 'Helmet Mounted'),
                      ...
                      _buildTableRow('Weight', '< 700g (without battery)'),
            ],
          ),
      ],
    );
